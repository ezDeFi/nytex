...
export default class extends AdminPage {
    ...
    async componentDidMount() {
        ...
        await this.props.getLeaderBoardAdmin()
    }
    ...
    onChangeDatePicker(date, dateString) {
        this.props.getLeaderBoardAdmin({
    ...
    ord_renderContent () {
        ...
        if (this.state.usernameFilter) {
            list = list.filter((item) => {
                ...
                return (
                    regExp.test(item.user.username)
                )
            })
        }
                    ...
                    <div className="p_admin_content">
                        <Row>
                            <Col span={4} className="admin-left-column wrap-box-navigator">
                                <Navigator selectedItem={'leaderboard'}/>
                            </Col>
                            <Col span={20} className="admin-right-column wrap-box-user">
                                ...
                                <List onChangeDatePicker={this.onChangeDatePicker.bind(this)} loading={this.props.loading} list={list}/>
                            </Col>
                        </Row>
                    </div>
                </div>
