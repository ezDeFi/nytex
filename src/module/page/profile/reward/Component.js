                    ...
                    <div className="d_box">
                        <div className="p_admin_breadcrumb">
                            <Breadcrumb>
                                ...
                                <Breadcrumb.Item>Reward History</Breadcrumb.Item>
                            </Breadcrumb>
                        </div>
                        <div className="p_Profile p_admin_content">
                            ...
                            <Row>
                                ...
                                <Col xs={{span: 24}} md={{span: 20}} className="c_ProfileContainer admin-right-column wrap-box-user">
                                    <RewardList onChangeDatePicker={this.onChangeDatePicker.bind(this)} list={this.props.list} loading={this.props.loading} />
                                </Col>
                            </Row>
                            <Row>
                                <Col>
