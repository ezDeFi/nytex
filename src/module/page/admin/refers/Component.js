...
import ReferList from './ReferList/Container'
                ...
                <div className="d_box">
                    <div className="p_admin_breadcrumb">
                        <Breadcrumb>
                            ...
                            <Breadcrumb.Item>Refers</Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                    <div className="p_admin_content">
                        <Row>
                            <Col span={4} className="admin-left-column wrap-box-navigator">
                                <Navigator selectedItem={'refers'}/>
                            </Col>
                            <Col span={20} className="admin-right-column wrap-box-user">
                                ...
                                <ReferList onChangeDatePicker={this.onChangeDatePicker.bind(this)} loading={this.props.loading_refer} list={list}/>
                            </Col>
                        </Row>
                    </div>
                </div>
