    ...
    <div className="absorption">
      ...
      <div className="absorption-content">
        <Row className="margin-bt-md">
          ...
          <Col lg={20}>0x371Fd45453fCe637E6035779eE0a9eeE53665Ae9</Col>
        </Row>
        <Row className="margin-bt-sm">
          <Col lg={4}><b>Stake:</b></Col>
          <Col lg={20}>
            <Row>
              <Col lg={5}>0 Million NTY</Col>
        ...
        <Row>
          ...
          <Col lg={20}>
            <Row>
              <Col lg={5}>7 days</Col>
              <Col lg={19}><button className="absorption-content--btn-provoke">Provoke</button></Col>
            </Row>
          </Col>
        </Row>
      </div>
