...
const OrderBookBuySale = () => {
  ...
  return [
      <p className="order-book__title" key={'order-book-' + 0}>Orderbook</p>,
      <div className="order-book__sale-table" key={'order-book-' + 1}>
        <Table dataSource={dataSource} columns={salecolumns} pagination={false} />;
      </div>,
      <div className="order-book__buy-table" key={'order-book-' + 2}>
